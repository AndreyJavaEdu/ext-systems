...
VALUES (1, 'улица Генерала Горбатова');
...
INSERT INTO cr_person (surname, given_name, patronomyc, date_of_birth,
                       pasport_seria, passport_number, passport_date,
                       certificate_number, certificate_date)
VALUES ('Васильев', 'Павел', 'Николаевич', '1995-03-18', '1234', '123456',
        '2015-04-11', null, null);

INSERT INTO cr_person (surname, given_name, patronomyc, date_of_birth,
                       pasport_seria, passport_number, passport_date,
                       certificate_number, certificate_date)
VALUES ('Васильева', 'Ирина', 'Петровна', '1997-08-18', '4321', '654321',
        '2017-09-19', null, null);

INSERT INTO cr_person (surname, given_name, patronomyc, date_of_birth,
                       pasport_seria, passport_number, passport_date,
                       certificate_number, certificate_date)
VALUES ('Васильева', 'Евгения', 'Павловна', '2016-01-11', null, null, null, '456123',
        '2016-01-24');

INSERT INTO cr_person (surname, given_name, patronomyc, date_of_birth,
                       pasport_seria, passport_number, passport_date,
                       certificate_number, certificate_date)
VALUES ('Васильев', 'Александр', 'Петрович', '2018-11-10', null, null, null, '321654',
        '2018-11-19');

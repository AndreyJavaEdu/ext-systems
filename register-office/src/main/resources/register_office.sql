...
CREATE TABLE ro_birth_certificate
    (
        ...
        number_certificate varchar not null,
        date_issue date not null,
        person_id integer not null,
...
INSERT INTO ro_passport (person_id, number, seria, date_issue, issue_department)
VALUES (1, '40000', '123456', '2018-04-10', 'Department Passport №1');
